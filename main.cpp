...
class Node{
    ...
    */
    ...
    public:
        ...
        void set_current_color(Color color_to_set){
        ...
        void set_next_color(Color color_to_set){
        ...
        friend std::ostream& operator<<(std::ostream& os, const Node& node) {
            ...
            os << "Vertex Color (R,G,B): " << static_cast<int>(node.current_color.R) << "," 
                                        << static_cast<int>(node.current_color.G) << "," 
                                        << static_cast<int>(node.current_color.B) << std::endl; 
            // Imprime os vizinhos do nó.
            os << "Vertex neighbors: " << node.get_neighbors_as_string() << std::endl;
...
class Graph{
    ...
    */          
    ...
    public:
        ...
        Color nodes_color[NODES_NUMBER];
